...
class CreateRecordsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('records', function (Blueprint $table) {
            ...
            $table->integer('lagat_behorne_anne_option')->unsigned();
            ...
            $table->integer('aayojana_hune_woda')->unsigned();
            $table->integer('pramukha_prashasakiyeko_name')->unsigned();
            $table->string('adaxyako_number');
            $table->string('kaifiyet');

            $table->foreign('lagat_behorne_anne_option')->references('id')->on('lagat_behorne_srot_options');
            $table->foreign('pramukha_prashasakiyeko_name')->references('id')->on('ppa_options');
            $table->foreign('aayojana_hune_woda')->references('id')->on('ward_options');

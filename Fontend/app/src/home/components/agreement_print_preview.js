...
export class AgreementPrintPreview extends React.Component{
    ...
    componentDidMount() {
        ...
        axios({
            ...
            data:{'projectId': this.props.location.id},
        }).then((response)=> {
            console.log(response.data);
            let receivedData = this.state.receivedData;
            receivedData.padadhikariharu = response.data[2];
                    ...
                    <div id="agreement_a4" ref={el => (this.componentRef = el)}>
                        ...
                        <div id="body">
                                    ...
                                    <div className="sub-title">
                                        <table id="simple">
                                            <tr>
                                                ...
                                                <td><b>{this.state.receivedData.project.upabhokta_samitiko_naam}</b></td>
                                            </tr>
                                            <tr>
                                                <td><span>२) ठेगाना :</span></td>
                                                <td><b>{this.state.receivedData.project.upabokta_samitiko_thegana}</b></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                <div className="title">
                                    ...
                                    <div className="sub-title">
                                        <table id="simple">
                                            <tr>
                                                <td><span>१) नाम :</span></td>
                                                <td><b>{this.state.receivedData.project.aayojanako_naam}</b></td>
                                            </tr>
                                            <tr>
                                                <td><span>२) आयोजना स्थल :</span></td>
                                                <td><b>{this.state.receivedData.project.aayojanako_sthal}</b></td>
                                            </tr>
                                            <tr>
                                                <td><span>३) उदेश्य :</span></td>
                                                <td><b>{this.state.receivedData.project.aayojanako_udeshya}</b></td>
                                            </tr>
                                            <tr>
                                                <td><span>४) आयोजना सुरु हुने मिति :</span></td>
                                                <td><b>{this.state.receivedData.project.aayojana_suru_miti}</b></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div className="item">
                                ...
                                <div className="title">
                                    <div id="name">
                                        क) लागत अनुमान रु : <b>{this.state.receivedData.project.lagat_anuman}</b>
                                    </div>
                                </div>
                                <div className="title">
                                    <div id="name">
                                    ...
                                    <div className="sub-title">
                                        <table id="simple">
                                            <tr>
                                                ...
                                                <td><b>{this.state.receivedData.project.lagat_behorne_karyalay}</b></td>
                                            </tr>
                                            <tr>
                                                <td><span>२) उपभोत्ता समिति :</span></td>
                                                <td><b>{this.state.receivedData.project.lagat_behorne_upobhokta_samiti}</b></td>
                                            </tr>
                                            <tr>
                                                <td><span>३) अन्य</span></td>
                                                <td><b>{this.state.receivedData.project.lagat_behorne_anne}</b></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                <div className="title">
                                    ...
                                    <div className="sub-title">
                                        <table border="1" id="table">
                                            ...
                                            <tr>
                                                <td>१</td><td>संघबाट</td><td><b>{this.state.receivedData.project.bastugat_anudan_sangbata_samagriko_naam}</b></td><td><b>{this.state.receivedData.project.bastugat_anudan_sangbata_ekai}</b></td>
                                            </tr>
                                            <tr>
                                                <td>२</td><td>प्रदेशबाट</td><td><b>{this.state.receivedData.project.bastugat_anudan_pradeshbata_samagriko_naam}</b></td><td><b>{this.state.receivedData.project.bastugat_anudan_pradeshbata_ekai}</b></td>
                                            </tr>
                                            <tr>
                                                <td>३</td><td>स्थानीय तहबाट</td><td><b>{this.state.receivedData.project.bastugat_anudan_sthaniyebata_samagriko_naam}</b></td><td><b>{this.state.receivedData.project.bastugat_anudan_sthaniyebata_ekai}</b></td>
                                            </tr>
                                            <tr>
                                                <td>४</td><td>गैह्रसरकारी तहबाट</td><td><b>{this.state.receivedData.project.bastugat_anudan_gairasarakaribata_samagriko_naam}</b></td><td><b>{this.state.receivedData.project.bastugat_anudan_gairasarakaribata_ekai}</b></td>
                                            </tr>
                                            <tr>
                                                <td>५</td><td>विदेशी दातृ निकायबाट</td><td><b>{this.state.receivedData.project.bastugat_anudan_bideshbata_samagriko_naam}</b></td><td><b>{this.state.receivedData.project.bastugat_anudan_bideshbata_ekai}</b></td>
                                            </tr>
                                            <tr>
                                                <td>६</td><td>उपभोक्ता समितिबाट</td><td><b>{this.state.receivedData.project.bastugat_anudan_upobhoktasamitibata_samagriko_naam}</b></td><td><b>{this.state.receivedData.project.bastugat_anudan_upokhoktasamitibata_ekai}</b></td>
                                            </tr>
                                            <tr>
                                                <td>६</td><td>अन्य निकायबाट</td><td><b>{this.state.receivedData.project.bastugat_anudan_anne_samagriko_naam}</b></td><td><b>{this.state.receivedData.project.bastugat_anudan_anne_ekai}</b></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                    ...
                                    <div className="sub-title">
                                        <table id="simple">
                                            <tr>
                                                ...
                                                <td><b>{this.state.receivedData.project.aayojana_labhanbit_gharpariwar_sangkhya}</b></td>
                                            </tr>
                                            <tr>
                                                <td><span>२) जनसंख्या :</span></td>
                                                <td><b>{this.state.receivedData.project.aayojana_labhanbit_janasankhya}</b></td>
                                            </tr>
                                            <tr>
                                                <td><span>३) संगठित संख्या :</span></td>
                                                <td><b>{this.state.receivedData.project.aayojana_labhanbit_sangathit_sangkhya}</b></td>
                                            </tr>
                                            <tr>
                                                <td><span>३) अन्य :</span></td>
                            ...
                            <div className="item">
                                ...
                                <div className="title">
                                    <div id="name">
                                        क) गठन भएको मिति : <b>{this.state.receivedData.project.gathan_vayeko_miti}</b>
                                    </div>
                                </div>
                                <div className="title">
                                    <div id="name">
                                    ...
                                    <div className="sub-title">
                                        <table border="1" id="table">
                                            ...
                                            {this.state.receivedData.padadhikariharu.map((item,index)=>{
                                                return <tr key={index}>
                                ...
                                <div className="title">
                                    <div id="name">
                                        क) उपभोक्ता समिति गठन गर्दा उपस्थित लाभान्वितको संख्या  : <b>{this.state.receivedData.project.upobhokta_samiti_gathan_garda_upasthit_labhanbit_sangkhya}</b>
                                    </div>
                                </div>
                            </div>
                            <div className="item">
                                <div id="name">
                                    ४) आयोजना संचालन सम्बन्धि अनुभव वर्ष : <b>{this.state.receivedData.project.anubhav_barsa}</b>
                                </div>
                            </div>
                            <div className="item">
                                <div id="name">
                                ...
                                <div className="title">
                                    <table border="1" id="table">
                                        ...
                                        <tr>
                                            <td>प्रथम</td><td><b>{this.state.receivedData.project.pratham_miti}</b></td><td><b>{this.state.receivedData.project.pratham_rakam}</b></td><td><b>{this.state.receivedData.project.pratham_samagriko_pariman}</b></td><td><b>{this.state.receivedData.project.pratham_kaifiyet}</b></td>
                                        </tr>
                                        <tr>
                                            <td>दोस्रो</td><td><b>{this.state.receivedData.project.dorshro_miti}</b></td><td><b>{this.state.receivedData.project.dorshro_rakam}</b></td><td><b>{this.state.receivedData.project.dorshro_samagriko_pariman}</b></td><td><b>{this.state.receivedData.project.dorshro_kaifiyet}</b></td>
                                        </tr>
                                        <tr>
                                            <td>तेस्रो</td><td><b>{this.state.receivedData.project.teshro_miti}</b></td><td><b>{this.state.receivedData.project.teshro_rakam}</b></td><td><b>{this.state.receivedData.project.teshro_samagriko_pariman}</b></td><td><b>{this.state.receivedData.project.teshro_kaifiyet}</b></td>
                                        </tr>
                                        <tr>
                                            <td>जम्मा</td><td><b>{this.state.receivedData.project.jamma_miti}</b></td><td><b>{this.state.receivedData.project.jamma_rakam}</b></td><td><b>{this.state.receivedData.project.jamma_samagriko_pariman}</b></td><td><b>{this.state.receivedData.project.jamma_kaifiyet}</b></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div className="title">
                                    <table id="simple">
                                        <tr>
                                            ...
                                            <td><b>{this.state.receivedData.project.yojana_marmat_jimma_line_samiti}</b></td>
                                        </tr>
                                        <tr>
                                            <td><span>ख ) मर्मत सम्भारको सम्भावित श्रौत (छ छैन खुलाउने ) :</span></td>
                                            <td><b>{this.state.receivedData.project.marmat_sambhabit_srot}</b></td>
                                        </tr>
                                        <tr>
                                            <td><span>ग ) जनश्रमदान : </span></td>
                                            <td><b>{this.state.receivedData.project.janasramdan}</b></td>
                                        </tr>
                                        <tr>
                                            <td><span>घ ) सेवा शुल्क : </span></td>
                                            <td><b>{this.state.receivedData.project.sewa_sulka}</b></td>
                                        </tr>
                                        <tr>
                                            <td><span>ङ ) दस्तुर चन्दाबाट : </span></td>
                                            <td><b>{this.state.receivedData.project.dastur_chandabata}</b></td>
                                        </tr>
                                        <tr>
                                            <td><span> च ) अन्य केही भए : </span></td>
                                            <td><b>{this.state.receivedData.project.anne_kehi_vaye}</b></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div id="sarta">
                            ...
                            <ol>
                                <li>आयोजना शुरु मिति <b>{this.state.receivedData.project.aayojana_suru_miti}</b> देखि शुरु गरी मिति <b>{this.state.receivedData.project.aayojana_ante_miti}</b> सम्ममा पुरा गर्नु पर्नेछ ।</li>
                            ...
                            <div id="left">
                                ...
                                <table id="agree">
                                    ...
                                    <tr>
                                        <td>नाम थर :</td><td><b>{this.state.receivedData.padadhikariharu[0].name}</b></td>
                                    </tr>
                                    <tr>
                                        <td>पद :</td><td><b>{this.state.receivedData.padadhikariharu[0].pada}</b></td>
                                    </tr>
                                    <tr>
                                        <td>ठेगाना :</td><td><b>{this.state.receivedData.padadhikariharu[0].thegana}</b></td>
                                    </tr>
                                    <tr>
                                        <td>सम्पर्क नम्बर :</td><td><b>{this.state.receivedData.project.adaxyako_number}</b></td>
                                    </tr>
                                    <tr>
                                        <td>मिति :</td><td><b>{this.state.receivedData.project.aayojana_suru_miti}</b></td>
                                    </tr>
                                </table>
                            </div>
                            <div id="right">
                                ...
                                <table id="agree">
                                    ...
                                    <tr>
                                        <td>नाम थर :</td><td><b>{this.state.receivedData.project.ppaName}</b></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>सम्पर्क नम्बर :</td><td><b>{this.state.receivedData.project.ppaPhone}</b></td>
                                    </tr>
                                    <tr>
                                        <td>मिति :</td><td><b>{this.state.receivedData.project.aayojana_suru_miti}</b></td>
                                    </tr>
